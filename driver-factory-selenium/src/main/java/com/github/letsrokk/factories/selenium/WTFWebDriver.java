...
import com.github.letsrokk.factories.ExtendedDriver;
...
public class WTFWebDriver implements ExtendedDriver {
    ...
    protected static Logger logger = LogManager.getLogger(SelenoidFactory.class);

    protected WebDriver originalDriver;
    protected WebDriverTimeouts timeouts;
    protected GridApiUtils gridApiUtils;
